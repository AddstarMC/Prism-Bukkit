...
public class MaterialTag implements Tag<Material> {
	...
	public static final MaterialTag DYES = new MaterialTag(
			...
			Material.COCOA_BEANS, Material.LAPIS_LAZULI, Material.PURPLE_DYE,
			Material.CYAN_DYE, Material.LIGHT_GRAY_DYE, Material.GRAY_DYE,
			Material.PINK_DYE, Material.LIME_DYE, Material.DANDELION_YELLOW,
			Material.LIGHT_BLUE_DYE, Material.MAGENTA_DYE, Material.ORANGE_DYE,
			Material.BONE_MEAL);
	...
	public static final MaterialTag PLANTS = new MaterialTag(
			...
			Material.PINK_TULIP, Material.OXEYE_DAISY, Material.BROWN_MUSHROOM,
			Material.RED_MUSHROOM, Material.LILY_PAD, Material.KELP, Material.KELP_PLANT
