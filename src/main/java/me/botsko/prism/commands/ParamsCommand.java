    ...
    private void help(CommandSender s) {
        TextComponent.Builder builder = Component.text()
                ...
                .append(Prism.messenger.playerMsg(colourParamHelp(
                        Il8n.getMessage("params-radius-help")))).append(Component.newline())
                .append(Prism.messenger.playerMsg(
                        colourParamHelp(Il8n.getMessage("params-radius-help2")))).append(Component.newline())
                .append(Prism.messenger.playerMsg(
                        colourParamHelp(Il8n.getMessage("params-radius-help3")))).append(Component.newline())
                .append(Prism.messenger.playerMsg(
                        colourParamHelp(Il8n.getMessage("params-radius-help4")))).append(Component.newline())
                ...
                .append(Il8n.getMessage("params-help-action")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("b:[block] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-block")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("before:[time] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-before")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("e:[entity] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-entity")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("id:[#] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-id")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("k:[text] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-keyword")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("p:[player] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-player")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("since:[time] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-since")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("t:[time] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-time")).append(Component.newline())
                .append(Prism.messenger.playerMsg(Component.text("w:[world] ").color(NamedTextColor.LIGHT_PURPLE)))
                .append(Il8n.getMessage("params-help-world")).append(Component.newline())
                .append(Il8n.getMessage("params-help-prefix")).append(Component.newline())
                .append(Il8n.getMessage("params-help-partial")).append(Component.newline())
                .append(Il8n.getMessage("params-help-actionlist")).append(Component.newline());
