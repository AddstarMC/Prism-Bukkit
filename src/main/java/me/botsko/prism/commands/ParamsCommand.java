...
public class ParamsCommand implements SubHandler {
	...
	private void help(CommandSender sender) {
		...
		sender.sendMessage(Prism.messenger.playerMsg(ChatColor.LIGHT_PURPLE + "r:<player|x,y,z>:[radius]" + ChatColor.WHITE
		...
		sender.sendMessage(Prism.messenger.playerMsg("Prefix action, player, or entity names with ! to exclude. Like p:!viveleroi"));
