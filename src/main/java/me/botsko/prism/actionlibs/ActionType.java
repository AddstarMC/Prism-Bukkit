...
public class ActionType {
	...
	/**
	 * Returns whether or not an action type should also trigger a rollback action
	 * after an applier.
	 * 
	 * This is a pretty inefficient way to define the relationships but it's really
	 * the only way I can think of atm.
	 * 
	 * @param at
	 * @return
	 */
