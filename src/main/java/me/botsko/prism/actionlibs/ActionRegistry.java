...
public class ActionRegistry {
	...
	private void registerPrismDefaultActions(){
		...
		registerAction( new ActionType( "vehicle-break", false, true, true, "VehicleAction", "broke") );
		...
		registerAction( new ActionType( "vehicle-place", true, true, true, "VehicleAction", "placed") );
