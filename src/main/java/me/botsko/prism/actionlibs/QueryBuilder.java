...
public class QueryBuilder {
	...
	public String buildQuery( QueryParameters parameters, boolean shouldGroup ){
		...
		if(id > 0){
			...
			if(loc != null){
				addCondition( String.format(tableName+".x = %d",loc.getBlockX()) );
				addCondition( String.format(tableName+".y = %d",loc.getBlockY()) );
				addCondition( String.format(tableName+".z = %d",loc.getBlockZ()) );
			}
